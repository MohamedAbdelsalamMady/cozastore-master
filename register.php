...
if (isset($_POST['submit'])) {
	...
	$user_type = mysqli_real_escape_string($conn, $_POST['user_type']); // Get the user_type
		...
		<div class="sidebar flex-col-l p-t-22 p-b-25">
			...
			<div class="sidebar-content flex-w w-full p-lr-65 js-pscroll">
				<ul class="sidebar-link w-full">
					...
					<li class="p-b-13">
						<a href="wishlist.html" class="stext-102 cl2 hov-cl1 trans-04">
							My Wishlist
						</a>
					</li>

					<li class="p-b-13">
						<a href="account.html" class="stext-102 cl2 hov-cl1 trans-04">
							My Account
						</a>
					</li>

					<li class="p-b-13">
						<a href="register.html" class="stext-102 cl2 hov-cl1 trans-04">
							Create Account
						</a>
					</li>
					...
					<li class="p-b-13">
						<a href="AnswersandQuestions.html" class="stext-102 cl2 hov-cl1 trans-04">
							Help & FAQs
						</a>
					</li>
				</ul>
...
<!--End of Sign Modal-->
    ...
    <section class="bg-img1 txt-center p-lr-15 p-tb-92" style="background-image: url('images/bg-02.jpg');">
		...
		<div class="wrap-input validate-input m-b-25" data-validate="Enter password">
            ...
            <span class="focus-input100"></span>
					  ...
					  <div class="col-12">
                        <div class="form-floating mb-3">
                          <input type="hidden" class="form-control" name="user_type" id="user_type" value="user" placeholder="Password" required>
            ...
            <button type="submit" class="register-form-btn" name="submit" class="">Sign Up</button>
        </div>
        ...
        <div class="flex-c-m">
            <a href="#" class="register-social-item bg1 m-r-5">
        ...
        <div class="text-center">
            ...
            <a href="index.php" class="txt2 hov1">Sign In</a>
        </div>
